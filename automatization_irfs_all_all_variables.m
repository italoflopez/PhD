% Define save path
savePath = 'C:\Users\Italo\OneDrive\Documents\PhD\PhD\First\resultados_muestra_total_interanual_betas_en_nivel_2_rezagos_con_nuevas_fast_todas_las_variables_credito_fast_sin_nonborres.docx'; % Change this to your desired path
...
allVars = model_estimation_variables.Properties.VariableNames;
% Define variables and their corresponding indices
variables = setdiff(allVars, excludeVars, 'stable'); % Example for standard IRFs
varIndices = 1:111; % Corresponding indices

restrictedVars = strcat(variables, '_Restricted');% Example for restricted IRFs
restrictedIndices = 1:111; % Corresponding indices
