...
restrictedVars = {'Inflation Restricted','IP Restricted',  'Capacity utilization, total Restricted','Employment Restricted',...
    'Industrial and Commercial Loans Restricted','Non-revolving consumer credit Restricted','Unemployment Rate Restricted',...
    'Average Hourly Earnings Restricted','Depreciation of the US Dollar against the UK Sterling Pound Restricted',...
    'M1 Restricted','M2 Restricted','S&P 500 Restricted','Commodities Price Index Restricted','Finance Rate 24-month Loans Restricted',...
    '30-year mortgage rate minus 10-year Treasury yield Restricted'}; % Example for restricted IRFs
